      ...
      <div class="widget-box">
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            ...
            <div class="span3">
              <ul class="site-stats">
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_user}}</strong> <small>Total Users</small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_admin}}</strong> <small>Total Admin </small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_male_user}}</strong> <small>Total Male User</small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_active_admin}}</strong> <small>Total Active Admin</small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_female_user}}</strong> <small>Total Female User</small></li>
                <li class="bg_lh"><i class="icon-user"></i> <strong>{{$total_inactive_admin}}</strong> <small>Total Inactive Admin</small></li>
              </ul>
            </div>
          </div>
        </div>
...
<script src="{{Request::root()}}/assets/admin/js/excanvas.min.js"></script>
...
<script src="{{Request::root()}}/assets/admin/js/jquery.flot.min.js"></script>
<script src="{{Request::root()}}/assets/admin/js/jquery.flot.resize.min.js"></script>
<script src="{{Request::root()}}/assets/admin/js/jquery.peity.min.js"></script>
<script src="{{Request::root()}}/assets/admin/js/fullcalendar.min.js"></script>
<script src="{{Request::root()}}/assets/admin/js/matrix.dashboard.js"></script>
<script src="{{Request::root()}}/assets/admin/js/jquery.gritter.min.js"></script>
<script src="{{Request::root()}}/assets/admin/js/matrix.interface.js"></script>
<script src="{{Request::root()}}/assets/admin/js/matrix.chat.js"></script>
...
<script src="{{Request::root()}}/assets/admin/js/jquery.wizard.js"></script>
...
<script src="{{Request::root()}}/assets/admin/js/matrix.popover.js"></script>
